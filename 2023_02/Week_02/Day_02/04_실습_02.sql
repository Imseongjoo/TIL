...
INSERT INTO
	users (first_name, last_name, birthday, city, country, email)
VALUES
	('first_name1', 'last_name1', '1000-01-01', NULL, NULL, NULL),
    ('first_name2', 'last_name2', '1000-01-01', NULL, NULL, NULL),
    ('first_name3', 'last_name3', '1000-01-01', NULL, NULL, NULL),
    ('first_name4', 'last_name4', '1000-01-01', NULL, NULL, NULL),
    ('first_name5', 'last_name5', '1000-01-01', NULL, NULL, NULL);

-- 문제 4
-- 2번 레코드의 first_name, last_name, birthday 필드 값을 자신의 이름, 성, 생년월일로 변경하시오.

UPDATE users
SET first_name = 'Seongjoo', 
	last_name = 'Lim', 
    birthday = '1994-12-28'
WHERE userId = 2;
...
DELETE FROM users
WHERE irst_name = 'Kwangsoo' and last_name = 'Lee';
