...
SELECT jobTitle, COUNT(*) FROM employees GROUP BY jobTitle ORDER BY COUNT(*) DESC, jobTitle DESC;
...
SELECT country, COUNT(*) FROM customers GROUP BY country ORDER BY COUNT(*) DESC, country DESC;
...
GROUP BY productLine HAVING max_stock < 9000;
...
FROM orderdetails GROUP BY orderNumber HAVING itemsCount >= 500 AND total >= 50000;